...
- `maxicourses_test/fetch_courseu_price.py` : collecte Course U (Super U Eysines) par recherche EAN directe (session Chrome 9222 validée, overlay promo fermé, state sauvegardée).
